...
const servicesLeft = [
  {
    ...
    description: "Comprehensive diagnostics for your vehicle.",
    icon: h1,
  },
  {
    title: "Car Cleaning",
  ...
  {
    title: "Auto Painting",
    description: "High-quality paint jobs for all vehicles.",
    icon: h4,
  },
];
...
const servicesRight = [
  {
    title: "Spare Parts",
    description: "Genuine and high-quality auto parts.",
    icon: h2,
  },
  {
    title: "Service Guarantee",
    description: "Service warranty for quality assurance.",
    icon: h3,
  },
  {
    title: "Car Repairs",
    description: "Expert repairs for all vehicle issues.",
    icon: h5,
  },
];
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div className="space-y-6 text-right">
            {servicesLeft.map((service, index) => (
              <div
                key={index}
                className="flex items-center space-x-4 justify-center md:justify-end"
              >
                ...
                <img
                  className="bg-transparent w-12  rounded-full"
                  src={service.icon}
                  alt="icon"
                />
              </div>
          ...
          <div className="relative flex justify-center items-center">
            <img
              src={rotateimage}
              alt="Car Top View"
              className="w-72 h-72 object-cover absolute animate-spin"
