  ...
  const services = [
    {
      ...
      image: car_repair,
      description:
        "Comprehensive car repair solutions, including diagnostics, mechanical repairs, and electrical system troubleshooting to keep your vehicle in top condition.",
      svg: svg1,
    },
    {
      ...
      description:
        "Expert engine diagnostics and repairs to enhance performance, fix overheating issues, and extend the life of your vehicle's engine.",
      svg: svg3,
    },
    {
      ...
      description:
        "Specialized transmission repair services, including fluid change, gearbox maintenance, and complete transmission rebuilds for seamless gear shifting.",
      svg: svg4,
    },
    {
      ...
      description:
        "Precision gearbox repair services, covering diagnostics, repairs, and replacements to improve efficiency and driving comfort.",
      svg: svg5,
    },
    {
      ...
      description:
        "Expert steering system repairs, including rack and pinion fixes, power steering fluid replacement, and alignment adjustments for improved handling.",
      svg: svg6,
    },
    {
      ...
      description:
        "Suspension system inspections and repairs to enhance ride comfort, stability, and overall vehicle safety.",
      svg: svg7,
    },
    {
      ...
      description:
        "Professional detection and repair of engine oil, coolant, and transmission fluid leaks to prevent costly damage and ensure vehicle longevity.",
      svg: svg8,
    },
    {
      title: "Car AC Repair",
      image: car_ac_repair,
      description:
        "Specialized air conditioning repair services, including compressor replacement, refrigerant refilling, and climate control system diagnostics.",
      svg: svg9,
    },
    {
      ...
      description:
        "Cooling system repairs, including radiator flushing, thermostat replacement, and water pump repairs to prevent engine overheating.",
      svg: svg10,
    },
    {
      ...
      description:
        "Driveshaft balancing, U-joint repairs, and complete driveshaft replacement services to eliminate vibrations and ensure a smooth ride.",
      svg: svg11,
    },
    {
      ...
      description:
        "Comprehensive differential repair and maintenance services, including gear adjustments, bearing replacements, and lubrication services.",
      svg: svg12,
    },
    {
      ...
      description:
        "Expert transfer case repairs for four-wheel-drive and all-wheel-drive vehicles to maintain power distribution and off-road performance.",
      svg: svg13,
    },
    {
      title: "Car Wash",
      image: car_wash,
      description:
        "Professional car washing and detailing services to keep your vehicle clean and protected, using high-quality cleaning products.",
      svg: svg14,
    },
    {
      ...
      description:
        "Precision wheel alignment services to enhance fuel efficiency, prolong tire life, and improve vehicle handling.",
      svg: svg15,
    },
    {
      ...
      description:
        "High-quality Paint Protection Film (PPF) and window tinting services to protect your car's paint and enhance privacy.",
      svg: svg16,
    },
    {
      ...
      description:
        "Quick and efficient oil change services using high-quality engine oils to improve performance and extend engine life.",
      svg: svg17,
    },
    {
      ...
      description:
        "Specialized off-road modification services, including lift kits, suspension upgrades, and heavy-duty accessories for off-road adventures.",
      svg: svg18,
    },
    {
      ...
      description:
        "Complete interior and exterior car detailing services, including deep cleaning, polishing, and ceramic coating for a showroom finish.",
      svg: svg19,
    },
    {
      ...
      description:
        "Reliable car battery testing and replacement services to ensure your vehicle starts smoothly every time.",
      svg: svg20,
    },
  ];
